...
import fun.pizda.client.modules.impl.render.base.implement.*;
...
public class Interface extends Module {
    ...
    private static final long SLOW_HUD_ELEMENT_NANOS = Long.getLong("pizda.perf.hudMs", 5L) * 1_000_000L;
    private static final long PERF_WARN_COOLDOWN_NANOS = Long.getLong("pizda.perf.cooldownMs", 1000L) * 1_000_000L;
    ...
    public Interface() {
        ...
        this.waterMark = new WaterMark(Pizda.draggable(this, "WaterMark", 10, 10));
        this.arrayListHud = new ArrayListHud(Pizda.draggable(this, "ArrayList", 5, 24));
        this.keyBinds = new KeyBinds(Pizda.draggable(this, "KeyBinds", 30, 30));
        this.helperBinds = new HelperBinds(Pizda.draggable(this, "HelperBinds", 90, 30));
        this.potions = new Potions(Pizda.draggable(this, "Potions", 30, 60));
        this.staffList = new StaffList(Pizda.draggable(this, "StaffList", 60, 100));
        this.session = new Session(Pizda.draggable(this, "Session", 70, 30));
        this.keyStrokes = new KeyStrokes(Pizda.draggable(this, "KeyStrokes", 150, 120));
        this.information = new Information(Pizda.draggable(this, "Information", 50, 100));
        this.notifications = new Notifications(Pizda.draggable(this, "Notifications", 0, 0));
        this.targetHud = new TargetHud(Pizda.draggable(this, "TargetHud", 30, 90));
    }
