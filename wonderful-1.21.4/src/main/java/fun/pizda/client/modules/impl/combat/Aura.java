...
import fun.pizda.api.events.implement.EventKeyboardInput;
import fun.pizda.api.events.implement.EventMoveInput;
import fun.pizda.api.events.implement.EventUpdate;
import fun.pizda.api.events.implement.EventUpdatePost;
import fun.pizda.api.storages.implement.FreeLookStorage;
import fun.pizda.api.storages.implement.NeuroAuraStorage;
...
import fun.pizda.api.utils.input.MovingUtil;
import fun.pizda.api.utils.math.MathUtils;
import fun.pizda.api.utils.math.TimerUtils;
import fun.pizda.api.utils.player.HotbarUtil;
import fun.pizda.api.utils.player.SlotSearchResult;
import fun.pizda.api.utils.rotate.MultipointUtils;
...
import fun.pizda.client.modules.impl.combat.components.interpolation.BestPoint;
import fun.pizda.client.modules.impl.combat.components.rotations.LegitRotation;
import fun.pizda.client.modules.impl.combat.components.rotations.SlothRotation;
import fun.pizda.client.modules.impl.combat.components.rotations.TestRotation;
import fun.pizda.client.modules.impl.combat.components.rotations.WellMineRotation;
import fun.pizda.client.modules.impl.combat.components.rotations.WhiteRiseRotation;
...
public class Aura extends Module {
    ...
    public void onPlayerTick(EventUpdate e) {
        ...
        if (tpsSync == null && Pizda.INSTANCE != null && Pizda.INSTANCE.moduleStorage != null) {
