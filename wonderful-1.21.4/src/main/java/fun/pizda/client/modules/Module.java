package fun.pizda.client.modules;
...
import fun.pizda.api.utils.notification.NotificationManager;
...
public abstract class Module implements QClient {
    ...
    public String getDisplayName() {
        return Pizda.INSTANCE.localizationStorage == null ? name : Pizda.INSTANCE.localizationStorage.translate(name);
    }

    public String getDisplayDescription() {
        return Pizda.INSTANCE.localizationStorage == null ? description : Pizda.INSTANCE.localizationStorage.translate(description);
    }
