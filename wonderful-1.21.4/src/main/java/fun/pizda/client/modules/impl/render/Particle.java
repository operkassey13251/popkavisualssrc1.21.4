...
public class Particle extends Module {
    ...
    private static final Identifier STAR_TEXTURE = Identifier.of("pizda", "textures/particle/star.png");
    private static final Identifier HEART_TEXTURE = Identifier.of("pizda", "textures/particle/heart.png");
    private static final Identifier DOLLAR_TEXTURE = Identifier.of("pizda", "textures/particle/dollar.png");
