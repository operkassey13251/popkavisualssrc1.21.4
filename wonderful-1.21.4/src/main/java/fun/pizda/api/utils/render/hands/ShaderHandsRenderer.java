package fun.pizda.api.utils.render.hands;
...
import fun.pizda.client.modules.impl.render.ShaderHands;
...
public class ShaderHandsRenderer implements QClient {
    ...
    public void renderOverlayIfPending() {
        ...
        int color1 = Pizda.INSTANCE.themeStorage.getThemes().getTheme().getName().equals("Rainbow")
    ...
    private ShaderHands getModule() {
        if (Pizda.INSTANCE == null || ModuleClass.INSTANCE == null) return null;
