...
public class LocalizationStorage {
    ...
    public LocalizationStorage() {
        ...
        add("Молнии", "Lightning", "Блискавки");
        add("Кол-во молний", "Bolt Count", "Кількість блискавок");
        add("Сегменты молнии", "Bolt Segments", "Сегменти блискавки");
        add("Разброс молнии", "Bolt Spread", "Розкид блискавки");
        add("Частота молнии", "Bolt Rate", "Частота блискавки");
        add("Толщина молнии", "Bolt Width", "Товщина блискавки");
        add("Свечение молнии", "Bolt Glow", "Світіння блискавки");
        add("Ветви молнии", "Bolt Branches", "Гілки блискавки");
