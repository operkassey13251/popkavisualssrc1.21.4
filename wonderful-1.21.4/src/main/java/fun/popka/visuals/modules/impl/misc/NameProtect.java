...
import fun.popka.api.utils.replace.ReplaceUtils;
...
import fun.popka.mixin.ChatScreenAccessor;
...
public class NameProtect extends Module {
    ...
    private final TextSetting nickname = new TextSetting("Никнейм", "popka", 32);
    ...
    public String patch(String text) {
        ...
        if (friends.isState() && Popka.INSTANCE != null && Popka.INSTANCE.friendStorage != null) {
    ...
    public String getReplacementName() {
        ...
        return value == null || value.isBlank() ? "popka" : value;
    }
    ...
    private String patchGrief(String text) {
        ...
        String out = text.replaceAll("Анархия-\\d+", "Popkavisuals.fun");
        out = out.replaceAll("ГРИФ #\\d+", "Popkavisuals.fun");
        return out;
    }
    ...
    private String getPatchCacheKey(String text) {
        ...
        int friendsHash = 0;
        if (friends.isState() && Popka.INSTANCE != null && Popka.INSTANCE.friendStorage != null) {
            List<String> friendList = Popka.INSTANCE.friendStorage.getFriends();
    ...
    private boolean isFriendRemoveInputActive() {
        ...
        TextFieldWidget chatField = ((ChatScreenAccessor) chatScreen).Popka$getChatField();
        if (chatField == null) {
            return false;
        }
        ...
        String prefix = Popka.INSTANCE != null && Popka.INSTANCE.commandStorage != null
                ? Popka.INSTANCE.commandStorage.getPrefix().toLowerCase()
                : ".";
